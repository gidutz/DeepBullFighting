...
if __name__ == '__main__':
    ...
    cookie = 'ssession=eyJjc3JmX3Rva2VuIjp7IiBiIjoiTTJWbE16WTVaR1JqWkdGa05XWXhPVEl6TkRGbVpUY3pORE0wWldRd056Z3hZVE13TVdFME5RPT0ifX0.XcwpnQ.7vyPjIn6PF4XbjmPJc5cJ5ZMct4; deepracer_token=2c18a784-d852-44f9-9c5c-06370484051d'
    host = '172.20.1.54'
    ...
    while not done:
        ...
        print(obs, action, agent.reverse_action(action))
